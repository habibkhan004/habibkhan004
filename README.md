...
const habib = {
  ...
  education: "BS Computer Science — University of Peshawar (CGPA 3.71/4.00)",
  experience: "2+ years shipping web & mobile products",

  workingWith: ["MERN Stack", "Laravel", "React Native", "REST & GraphQL APIs"],
  exploring:   ["AI-powered apps", "System design", "Automation workflows"],
  philosophy:  "Readable code > clever code. Always.",

  askMeAbout: ["React", "Node.js", "Laravel", "React Native", "MongoDB", "MySQL"],
  funFact:    "I debug by explaining the problem out loud — usually to no one 🐤",
};
```
...
<br/>
<p align="left">
  <img src="https://skillicons.dev/icons?i=html,css,react,nextjs,redux,tailwind,bootstrap,sass,materialui,vite&theme=dark" />
</p>
</details>
...
<details open>
<summary><b>☁️ DevOps, Tools & Platforms</b></summary>
<br/>
<p align="left">
